...
func (app *application) showSnippet(w http.ResponseWriter, r *http.Request) {
	...
	// var := &struct returns ptr to anonymous obj. var:=struct returns actual obj. ptr.prop == (*ptr).prop
	// data := &templateData{Snippet: s}
	app.render(w, r, "show.page.tmpl", &templateData{
		Snippet: s,
	})

	// ... is called vararg func fx(str ...string)
...
func (app *application) signupUser(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, models.ErrDuplicateEmail) {
			form.Errors.Add("Address is already in use")
			app.render(w, r, "signup.page.tmpl", &templateData{Form: form})
		} else {
			app.serverError(w, err)
		}
...
func (app *application) loginUser(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			form.Errors.Add("Email or Password is incorrect")
